if exists('g:vscode')
    ...
    highlight Search guibg=Yellow guifg=Green
    ...
    autocmd FileType python iabbrev <buffer> _pdb import pdb; pdb.set_trace()
    autocmd FileType python iabbrev <buffer> _ic from icecream import ic
    func Eatchar(pat)
