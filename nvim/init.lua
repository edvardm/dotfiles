...
vim.keymap.set('n', 'K', '<cmd>lua vim.lsp.buf.hover()<CR>', {desc='Describe'})
...
require('lazy').setup({
	...
	{ 'neovim/nvim-lspconfig',
	  ...
	  dependencies = {
		  -- Replace with native support when nvim 0.10 is released
	...
	{ 'nvim-telescope/telescope.nvim',
	  tag = '0.1.4',
	  keys = {
		  { '<leader>tf', '<cmd>Telescope find_files<cr>', desc = 'Telescope fd' },
		  { '<leader>tg', '<cmd>Telescope live_grep<cr>', desc = 'Telescope rg' },
	  },
