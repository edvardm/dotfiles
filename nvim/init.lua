...
require('lazy').setup({{
    ...
    opts = {
        ensure_installed = {'go', 'rust', 'haskell', 'python', 'yaml', 'bash', 'json', 'lua', 'markdown',
                            'markdown_inline'}
    }
    ...
    dependencies = {'hrsh7th/cmp-nvim-lsp', 'hrsh7th/cmp-path', 'hrsh7th/cmp-cmdline', 'hrsh7th/cmp-buffer',
